...
fun main() {
    ...
    println("Груз с весом $weightLoad1 и объемом $sizeLoad1 соответствует категории \"Average\": ${AVERAGE_WEIGHT_MIN <= weightLoad1 && weightLoad1 <= AVERAGE_WEIGHT_MAX && sizeLoad1 < SIZE}")
    println("Груз с весом $weightLoad2 и объемом $sizeLoad2 соответствует категории \"Average\": ${AVERAGE_WEIGHT_MIN <= weightLoad2 && weightLoad2 <= AVERAGE_WEIGHT_MAX && sizeLoad2 < SIZE}")
}
